...
from abides_markets.agents.basic_agent import BasicAgent
...
def build_config(
    ...
    agents.append(
        BasicAgent(
            ...
            long_window=10,
            max_position=1000,
            wake_frequency=str_to_ns("30s"),
            cooldown_time=str_to_ns("1min"),
    ...
    agent_count += 1
    agent_types.extend(["TrendFollowerAgent"])
